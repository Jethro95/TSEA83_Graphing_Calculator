...
\texttt{1000} & mPC := ADR if flag\_N == \texttt{1} else mPC++ \\
\texttt{1000} & mPC := ADR if flag\_Z == \texttt{1} else mPC++ \\
\texttt{1000} & mPC := ADR if flag\_C == \texttt{1} else mPC++ \\
\texttt{1000} & mPC := ADR if flag\_V == \texttt{1} else mPC++ \\
\texttt{Others} & mPC++
\end{tabular}
