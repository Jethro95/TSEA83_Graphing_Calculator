...
\section{Apparaten}
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{drawings/display2.png}}
	\caption{Skärmdump.}
\end{figure}
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{drawings/calculation_lq.jpg}}
...
Pythonapplikation som genererar tiles passande VGA-motorns tileminne utifrån en TrueType-font (\texttt{.ttf}, helst en monospace-font), och en sträng med unicode-tecken. Skrivet för Python3 och kräver bildbiblioteket PIL eller Pillow installerat. Se \texttt{font}-mappen.
