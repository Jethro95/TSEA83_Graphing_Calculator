...
\node [block, right of=cpu, node distance=3.5cm] (keyboard) {Tangentbord};
\node [block, below of=keyboard] (keyboarddriver) {Tangentbordsmotor};

\draw [->] (keyboarddriver) -- node {} (memory);
