...
\begin{tabularx}{\textwidth}{lL}
  {\Large \textbf{ADD}} 	& {\Large \textbf{ADD binary}}\\
...
\setlength\extrarowheight{5pt} %Increase row spacing
\begin{tabularx}{\textwidth}{lL}
  {\Large \textbf{ADDF}} 	& {\Large \textbf{ADD float}}\\
  \textbf{Operation:} 		& \texttt{[destination] $\leftarrow$ [source] + [destination]}\\
...
\setlength\extrarowheight{5pt} %Increase row spacing
\begin{tabularx}{\textwidth}{lL}
  {\Large \textbf{BEQ}} 	& {\Large \textbf{Branch on condition cc}}\\
...
\setlength\extrarowheight{5pt} %Increase row spacing
\begin{tabularx}{\textwidth}{lL}
  {\Large \textbf{DIV}} 	& {\Large \textbf{Signed divide}}\\
  \textbf{Operation:} 		& \texttt{[destination] $\leftarrow$ [destination]/[source]}\\
  \textbf{Syntax:}  		& \texttt{DIV <ea>,Dn}\\
