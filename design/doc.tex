...
Nästan allt arbete utförs av processorn, förutom tangentbordläsning (dock parsing), och utritning av bildminnets innehåll. Dessa uppgifter inkluderar: beräkningar, historik, parsing av input, beräkning av graf, och så vidare.
