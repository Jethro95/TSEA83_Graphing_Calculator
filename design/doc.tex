...
Flyttalsupport ska finnas. Detta sköts i CPU:n snarare än i en separat flyttalsenhet; ett antal assembly-instruktioner interpreterar indata (och utdata) som flyttal snarare än heltal. Konvertering från användarinmatade flyttal till flyttal i minnet sker via programkod.
